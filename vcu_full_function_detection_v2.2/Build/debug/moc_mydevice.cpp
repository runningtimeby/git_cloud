...
#include <memory>
#include "../../vcu_full_function_detection_v2.2/myDevice/mydevice.h"
...
QT_MOC_LITERAL(1, 9, 15), // "canDataReceived"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "VCI_CAN_OBJ"
QT_MOC_LITERAL(4, 38, 7) // "canData"

    },
    "myDevice\0canDataReceived\0\0VCI_CAN_OBJ\0"
    "canData"
};
...
void myDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<myDevice *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->canDataReceived((*reinterpret_cast< const VCI_CAN_OBJ(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (myDevice::*)(const VCI_CAN_OBJ & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myDevice::canDataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myDevice::canDataReceived(const VCI_CAN_OBJ & _t1)
{
